...
import 'package:crm_project/HR-Views/Dashboard/DashboardPage.dart';
import 'package:crm_project/HR-Views/EmployeeComission/EmployeeCommisionList.dart';
import 'package:crm_project/HR-Views/Expenses/AddExpenses.dart';
import 'package:crm_project/HR-Views/Expenses/Expenses_Info_Account.dart';
...
class HRNavigationBar extends StatefulWidget {
  ...
  @override
  State<HRNavigationBar> createState() => _MyNavigationBarState();
}

class _MyNavigationBarState extends State<HRNavigationBar> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body:Center(
          child: HRNavigationBar._widgetOptions.elementAt(_selectedIndex),
        ),
