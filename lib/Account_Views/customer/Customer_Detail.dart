...
import 'package:crm_project/Account_Views/customer/controller/Update_Cutomer_controller.dart';
...
class CustomerDetail extends StatefulWidget {
  ...
  @override
  State<CustomerDetail> createState() => _ListYourPropertyScreenState();
}

class _ListYourPropertyScreenState extends State<CustomerDetail> {
  var Controller = Get.put(UpdateCustomerController());

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    Controller.CutomerName.text = widget.customer.name!;
    Controller.CutomerCnic.text = widget.customer.cnic.toString();
    Controller.Cutomeremail.text = widget.customer.email.toString();
    Controller.CutomerProperty.text = widget.customer.noOfProperty.toString();
    Controller.CutomerPhone.text = widget.customer.phone.toString();
    Controller.CutomerAddress.text = widget.customer.address.toString();
    Controller.CutomerSoldProperty.text = widget.customer.noOfSold.toString();
    Controller.ImageData = new File("");
    Controller.ImagePath.value = widget.customer.image.toString();
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Textfield(
                      hint: "Name",
                      contentPadding: 22,
                      Contorller: Controller.CutomerName,
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top: 20),
                  ...
                  Padding(
                    ...
                    child: Textfield(
                      hint: "Address",
                      contentPadding: 22,
                      Contorller: Controller.CutomerAddress,
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top: 20),
                  ...
                  Padding(
                    ...
                    child: Textfield(
                      ...
                      contentPadding: 22,
                      Contorller: Controller.Cutomeremail,
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.only(top: 20),
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Controller.addEmployee(widget.customer.sId!);
                      },
                      child: Obx(
                        () => Container(
                          height: 55,
      ...
      child: Obx(
        () => ClipOval(
          child: Controller.ImagePath.value == ""
              ? Image.network(
                  Controller.ImagePath.value, // Replace with your actual image path
                  fit: BoxFit.cover,
                )
