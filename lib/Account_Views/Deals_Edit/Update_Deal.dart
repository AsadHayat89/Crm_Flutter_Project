...
import 'package:crm_project/Account_Views/Deals_Edit/controller/Deal_Controller.dart';
...
class UpdateDeal extends StatefulWidget  {
  DealModel Deal;
  UpdateDeal({Key? key, required this.Deal}) : super(key: key);
  @override
  State<UpdateDeal> createState() => _ListYourPropertyScreenState();
}

class _ListYourPropertyScreenState extends State<UpdateDeal> {
  var Controller=Get.put(DealUpdateController());
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    Controller.PropertyName.text = "";
    Controller.PropertySize.text = widget.Deal.propertySize.toString();
    Controller.PropertyRoom.text = widget.Deal.rooms.toString();
    Controller.PropertyBedRoom.text = widget.Deal.bedroom.toString();
    Controller.PropertyBathRoom.text =widget.Deal.bathroom.toString();
    Controller.PropertyEmployeeName.text = widget.Deal.employeeName.toString();
    Controller.PropertyCustomerName.text = widget.Deal.customerName.toString();
    Controller.PropertyMoney.text = widget.Deal.actualPrice.toString();
    Controller.PropertySoldPrice.text = widget.Deal.soldPrice.toString();
    Controller.PropertyDescriptions.text = widget.Deal.description.toString();
    Controller.PropertyLocation.text = widget.Deal.location.toString();
    Controller.ImageUrl.value=widget.Deal.image.toString();
   // Controller.initialCustomerSlection=widget.Deal.customerCnic.toString();
    //Controller.initialEmployeeSlection=widget.Deal.employeeCnic.toString();
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          Controller.SendApi(widget.Deal.sId.toString()
                          );
