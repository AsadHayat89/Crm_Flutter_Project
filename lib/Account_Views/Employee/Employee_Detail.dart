                      ...
                      return GestureDetector(
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => EmployeeInfoPage(
                            empployee: Controller.allEmployee[index],
                          )));
                          // Navigator.of(context).push(MaterialPageRoute(builder: (context) => EmployeeInfoPage()));
                        },
                        child: Padding(
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                fit: BoxFit.cover,
                                                image:
                                                NetworkImage(ApiConstans.imageEmployeeBaseUrl+Controller.allEmployee[index].image!),
                                              ),
                                            ),
                                          ),
                                          SizedBox(
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          GestureDetector(
                                            onTap:(){
                                              print("Delete");
                                              Controller.deleteEmployee(Controller.allEmployee[index].sId!);
                                            },
                                            child: Container(
                                              decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(10),
