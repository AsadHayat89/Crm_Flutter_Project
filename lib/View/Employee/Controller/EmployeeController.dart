...
class EmployeeController extends GetxController{
  ...
  void addEmployee() async{
    if(EmployeeName.text==""){
      ConstantToast.GetToast("Error", "Please enter your Complete information and try again",
    ...
    else if(int.parse(EmployeeComission.text)<0 && int.parse(EmployeeComission.text)>100){
      ConstantToast.GetToast("Error", "Commission should be smaller then given value",
          Colors.red[100]!, Colors.red);
    }
